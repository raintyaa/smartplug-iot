...
<body class="h-full flex items-center justify-center p-4 relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-tr from-emerald-500 to-teal-400 shadow-xl shadow-emerald-500/20 mb-4">
                <i class="fa-solid fa-bolt text-slate-950 text-2xl"></i>
            </div>
